...
--
-- Host: localhost
-- Generation Time: Apr 14, 2016 at 11:19 PM
...
-- Database: `gpxdb`
--
CREATE DATABASE IF NOT EXISTS `gpxdb` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `gpxdb`;
...
DROP TABLE IF EXISTS `gx_address`;
...
DROP TABLE IF EXISTS `gx_address_street`;
...
DROP TABLE IF EXISTS `gx_autoroutepoint`;
...
DROP TABLE IF EXISTS `gx_categories`;
...
DROP TABLE IF EXISTS `gx_category`;
...
DROP TABLE IF EXISTS `gx_phonenumber`;
...
DROP TABLE IF EXISTS `gx_rptext`;
...
DROP TABLE IF EXISTS `gx_rteext`;
...
DROP TABLE IF EXISTS `gx_tptext`;
...
DROP TABLE IF EXISTS `gx_trkext`;
...
DROP TABLE IF EXISTS `gx_wptext`;
