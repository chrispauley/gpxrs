...
<title>GPXDB Webapp - 401 Not Authorized</title>
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<meta name="description" content="401 page for gpxdb.com. GPXDB is a REST enabled web application database storage and retrieval of gpx data.">
...
<div class="row-fluid">    
	<article class="offset2 span8">
      <header>
        ...
        <h3>Request requires user authentication</h3>
      </header>
